...
public class AccountTypeMenu {
    public void printAccountTypeOptions() {
        System.out.println("1. Regular Account without Interest");
        System.out.println("2. Regular Account with Interest");
        System.out.println("3. Euro Account without Interest");
